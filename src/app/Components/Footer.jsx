...
const FooterLink = ({ href, children }) => (
    <Link
      href={href}
      className="flex justify-center items-center block text-gray-200 text-xs text-m hover:text-white transition-colors duration-300 mb-2"
    >
      {children}
    </Link>
  );
  ...
  const FooterSection = ({ title, children }) => (
    <div>
      <h5 className="text-white text-sm mb-2 flex justify-center items-center">{title}</h5>
      {children}
    </div>
  );
        ...
        <footer >
            ...
            <div className="grid grid-cols-4 gap-4 m-8">
                <div>
                    ...
                    <h5>Our mission is to provide a free, world-class education to anyone, anywhere.</h5>
