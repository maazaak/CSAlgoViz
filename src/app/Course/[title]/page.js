  ...
  return (
    <section className="text-[#f7f8d7]">
      <div>
        ...
        <section className="h-screen  grid grid-cols-12 py-10 px-5">
            ...
            <div className="mt-14 gap-10 grid grid-cols-2">
              ...
              <div className="col-span-2">
                ...
                <div className="p-5 mt-10 bg-[#272822]">
                  ...
                  needed, which means the list is sorted. The algorithm gets its
                  name because smaller elements "bubble" to the top of the list
                  (beginning of the list) with each iteration, while the larger
                  elements sink to the bottom (end of the list). Despite its
                  simplicity, Bubble Sort is not suitable for large datasets as
                  its average and worst-case complexity are both quadratic,
                  making it inefficient compared to more advanced sorting
                  algorithms like quicksort or mergesort. However, its
                  simplicity and the fact that it makes no more than \(n-1\)
                  swaps in the best case (when the list is already sorted) can
                  make it useful for small datasets or as an educational tool to
